...
if(isset($this->breadcrumbs)):?>
	...
	<h3>Редактирование торговой точки</h3>
	...
	<input type="hidden" name="purchase_point_id" id="purchase_point_id" value="<?php echo $point->id;?>"/>
	<table width="100%" id="add_purchase_point" cellpadding="10" cellspacing="10">
	<tr>
	<td width="25%">Наименование:</td>
	<td width="25%">
	<input type="text" id="purchase_point_name" name="purchase_point_name" value="<?php if (isset($_REQUEST['purchase_point_name'])) echo $_REQUEST['purchase_point_name']; else echo $point->show_name?>"/>
	</td>
	<td width="50%" nowrap="">
	...
	<td width="25%">
	<input type="text" id="purchase_point_address" name="purchase_point_address" value="<?php if (isset($_REQUEST['purchase_point_address'])) echo $_REQUEST['purchase_point_address']; else echo $point->address?>"/>
	</td>
	<td width="50%">
	...
	<td width="25%">
	<input type="text" id="purchase_point_telephone" name="purchase_point_telephone" value="<?php if (isset($_REQUEST['purchase_point_telephone'])) echo $_REQUEST['purchase_point_telephone']; else echo $point->telephone?>"/>
	</td>
	<td width="50%">
	...
	<?php
		...
		elseif(isset($point->manager_id))
			$selected=$point->manager_id;
		else
			$selected=0;
	...
	<td width="25%">
	<input type="text" id="purchase_point_markup" name="purchase_point_markup" value="<?php if (isset($_REQUEST['purchase_point_markup'])) echo $_REQUEST['purchase_point_markup']; else echo $point->mark_up;?>"/>
	</td>
	<td width="50%">
	...
	<td width="25%">
	<input type="text" id="purchase_point_delivery_time" name="purchase_point_delivery_time" value="<?php if (isset($_REQUEST['purchase_point_delivery_time'])) echo $_REQUEST['purchase_point_delivery_time']; else echo $point->add_delivery_time;?>"/>
	</td>
	<td width="50%">
