...
<div style="width: 500px;padding: 4px;background: #fff;">
	...
	echo CHtml::dropDownList('client_id',$selected,$clients,array('id'=>'client_id','class'=>'list_clients','style'=>'margin-left:76px;'));
	else:?>
	Клиент <input type="text" id="client" value="<?php if(isset($_POST['client'])) echo $_POST['client'];?>">
...
<span>
	<button id="search" onclick="filter('admin_vin','<?php echo SITE_PATH.$this->current_url;?>');">Поиск</button>
</span>
<span>
