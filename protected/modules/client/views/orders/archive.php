...
if(isset($_POST['flag_filter']) or count($orders)>0):
 $this->Widget('application.modules.client.components.FilterWidget',array('current_url'=>$this->getRoute(),'action_view'=>$this->id,'type_date'=>$this->module->type_date[$this->getAction()->getId()],'num_items'=>count($orders),'current_model'=>'OrdersArchive'));
 endif;
...
<tr><th>№ заказа</th><th>Код детали</th><th>Производитель</th>
 <th>Описание</th><th>Сумма со скидкой, руб.</th><th>Кол-во</th><th style="border-right: 0px;">Дата продажи</th>
 <th>Комментарий</th>
 </tr>
 <?php 
...
?>
 ...
 <td style="border-right: 0px;<?php echo $style;?>"><?php echo CTime::change_show_data($order->data_shipping);?></td>
 <td style="border-right: 1px solid #bde0a3;">
...
<div class="pager">
<?php $this->Widget('application.components.PagerWidget',array('pages'=>$pages,'cssFile'=>$this->css_file_pager,'page_size'=>$this->page_size,'current_route'=>$this->getRoute(),'pager_place'=>'down'));?>
</div>